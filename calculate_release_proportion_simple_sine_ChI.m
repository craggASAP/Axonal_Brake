...
ChI_firing_rate(1033+baseline_time/2:1132+baseline_time/2,1)=0.5*sin((1/100*pi):1/100*pi:pi)+ChI_baseline_firing_rate;


DA_firing_rate=zeros(3000+baseline_time,1);
DA_baseline_firing_rate=6;
DA_increase_firing=20;
...
iefficiency_leave0=2.5;
iefficiency_reach1=4.45;
